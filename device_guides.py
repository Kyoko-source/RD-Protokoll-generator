...
DEVICE_GUIDES = {
    ...
    "Laerdal LSU": {
        ...
        "topics": {
            "Systemtest nach Hersteller": [
                "Vorbereitung: Patienten-Absaugschlauch vollständig abwickeln und sicherstellen, dass er weder geknickt noch blockiert ist.",
                "Absaugkatheter-Adapter aus seiner Halterung nehmen. Kanisterdeckel, T-Anschluss, Winkelanschluss und sämtliche Schläuche auf festen Sitz prüfen.",
                "TEST-Taste drücken und gedrückt halten. Gleichzeitig den Bedienknopf von 0 auf 500+ mmHg drehen.",
                "TEST-Taste erst loslassen, wenn der Bedienknopf mindestens 2 Sekunden auf 500+ mmHg gestanden hat. Die EIN-Anzeige blinkt im Testmodus schnell.",
                "Sobald LED 2 unten in der Batteriezustandsanzeige aufleuchtet – nach ungefähr 1 Sekunde – den Patienten-Absaugschlauch vollständig verschließen.",
                "Schlauch weiter vollständig verschlossen halten, während die LSU Vakuumaufbau, Maximalvakuum und Leckage prüft.",
                "Den Schlauch wieder freigeben, sobald LED 1 erneut aufleuchtet.",
                "Nach Testende wird Ergebnis 1 angezeigt. TEST-Taste jeweils einmal drücken, um nacheinander die Ergebnisse 2, 3 und 4 aufzurufen.",
                "Alle vier Ergebnisse prüfen: Blockade, Vakuumaufbau innerhalb 3 Sekunden, Maximalvakuum innerhalb 10 Sekunden und Leckage.",
                "Zum Beenden den Bedienknopf auf 0 drehen. Bei einem nicht bestandenen Test Ursache gemäß Herstelleranleitung prüfen, Test wiederholen und das Gerät andernfalls aus dem Betrieb nehmen.",
            ],
            ...
            "Schichtbeginn-Kurzcheck": [
                "Konfiguration feststellen: Serres-Absaugbeutel oder wiederverwendbarer Kanister. Nur die dazugehörigen Komponenten verwenden.",
                "Gerät, Kanister, Kanisterdeckel, Schläuche, Anschlüsse, Filter und Halterung auf Sauberkeit, Schäden und Vollständigkeit prüfen.",
                "Patienten-Absaugschlauch sicher an der PATIENTEN-Zuleitung anschließen; Filter und Vakuumleitung auf festen Sitz prüfen.",
                "Akku einsetzen beziehungsweise externe Versorgung kontrollieren. Der Systemtest soll die vorgesehene Einsatzkonfiguration einschließlich Kanister und Schläuchen prüfen.",
                "Hersteller-Systemtest starten: TEST gedrückt halten, Regler auf 500+ mmHg drehen und TEST mindestens 2 Sekunden gehalten lassen.",
                "Bei LED 2 den abgewickelten Patientenschlauch vollständig verschließen; bei erneutem Aufleuchten von LED 1 wieder freigeben.",
                "Mit der TEST-Taste alle vier Resultate aufrufen und prüfen. Erst bei vollständig bestandenem Systemtest als einsatzbereit kennzeichnen.",
                "Regler auf 0 zurückstellen, Zubehör ergänzen und die LSU entsprechend der lokalen Betreiberanweisung wieder in Ladebereitschaft bringen.",
            ],
        },
    },
    "MEDUMAT Standard²": {
